 ...
 */
public class CircleBookListAdapter extends BaseRecyclerAdapter<CircleBookObj> {
    View.OnClickListener clickListener;

    public CircleBookListAdapter(Context mContext, List<CircleBookObj> listData, View.OnClickListener clickListener) {
    ...
    public void bindData(RecyclerView.ViewHolder viewHolder, int position) {
        ...
        final CircleBookObj bookObj = listData.get(position);
