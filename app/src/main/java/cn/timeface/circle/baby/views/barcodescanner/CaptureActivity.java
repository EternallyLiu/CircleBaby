package cn.timeface.circle.baby.views.barcodescanner;
...
import static cn.timeface.circle.baby.support.utils.ToastUtil.showToast;
 ...
 * @author Sean Owen
 */
public final class CaptureActivity extends BaseAppCompatActivity
...
//        rlOpenDown = (RelativeLayout) findViewById(R.id.rl_capture_open_down);
        ...
        int screenHeightHalf = DeviceUtil.getScreenHeight(this) / 2;
