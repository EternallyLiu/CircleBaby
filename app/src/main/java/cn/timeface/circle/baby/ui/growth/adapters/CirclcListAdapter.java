...
public class CirclcListAdapter extends BaseRecyclerAdapter<CircleBookObj> {
    View.OnClickListener clickListener;

    public CirclcListAdapter(Context mContext, List<CircleBookObj> listData,View.OnClickListener clickListener) {
    ...
    public void bindData(RecyclerView.ViewHolder viewHolder, int position) {
        BookListAdapter.ViewHolder holder = (BookListAdapter.ViewHolder) viewHolder;
        CircleBookObj bookObj = listData.get(position);
