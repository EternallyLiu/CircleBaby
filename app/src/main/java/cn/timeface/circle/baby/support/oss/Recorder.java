...
import cn.timeface.circle.baby.support.oss.uploadservice.UploadTaskInfo;
...
public abstract class Recorder {
    ...
    public abstract String getTaskName(String taskId);

    public abstract ArrayList<UploadFileObj> getUploadFileObjs(String taskId);
}
