 ...
 */
public class CirclePhotosAdapter extends BaseRecyclerAdapter<GetCirclePhotoByUserObj> {
    ...
    public CirclePhotosAdapter(Context mContext, List<GetCirclePhotoByUserObj> listData, int maxCount, int contentType) {
    ...
    public void bindData(RecyclerView.ViewHolder viewHolder, int position) {
        ...
        GetCirclePhotoByUserObj item = getItem(dataPosition);
        if (viewType == TYPE_TITLE) {
