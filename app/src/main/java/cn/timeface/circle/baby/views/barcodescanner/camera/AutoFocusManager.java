...
package cn.timeface.circle.baby.views.barcodescanner.camera;
...
import cn.timeface.circle.baby.views.barcodescanner.config.Config;
...
final class AutoFocusManager implements Camera.AutoFocusCallback {
    ...
    public synchronized void onAutoFocus(boolean success, Camera theCamera) {
        if (active) {
            ...
            cn.timeface.circle.baby.views.barcodescanner.common.Runnable.execAsync(outstandingTask);
        }
    }
