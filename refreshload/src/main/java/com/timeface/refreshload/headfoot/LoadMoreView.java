package com.timeface.refreshload.headfoot;
...
public abstract class LoadMoreView extends LinearLayout {
    ...
    private void computeOffsetWith(RecyclerView recyclerView) {
       ...
       /* if (recyclerView.getAdapter().getItemCount() < PullRefreshLoadRecyclerView.REQ_PAGE) {
            setTranslationY(-recyclerView.getHeight() + getMeasuredHeight() / 2);
